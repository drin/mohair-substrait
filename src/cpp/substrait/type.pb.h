...
/* @@protoc_insertion_point(class_definition:substrait.Type.IntervalCompound) */ {
 public:
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "substrait.Type.IntervalCompound"; }
...
/* @@protoc_insertion_point(class_definition:substrait.Type) */ {
 ...
 public:
  ...
  void set_allocated_interval_compound(::substrait::Type_IntervalCompound* value);
  void unsafe_arena_set_allocated_interval_compound(::substrait::Type_IntervalCompound* value);
...
inline const ::substrait::Type_IntervalCompound& Type::_internal_interval_compound() const {
  return kind_case() == kIntervalCompound ? *_impl_.kind_.interval_compound_ : reinterpret_cast<::substrait::Type_IntervalCompound&>(::substrait::_Type_IntervalCompound_default_instance_);
}
inline const ::substrait::Type_IntervalCompound& Type::interval_compound() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void Type::unsafe_arena_set_allocated_interval_compound(::substrait::Type_IntervalCompound* value) {
  // We rely on the oneof clear method to free the earlier contents
  // of this oneof. We can directly use the pointer we're given to
  // set the new value.
  clear_kind();
...
inline ::substrait::Type_IntervalCompound* Type::_internal_mutable_interval_compound() {
  if (kind_case() != kIntervalCompound) {
    ...
    _impl_.kind_.interval_compound_ =
        ::google::protobuf::Message::DefaultConstruct<::substrait::Type_IntervalCompound>(GetArena());
  }
  return _impl_.kind_.interval_compound_;
}
inline ::substrait::Type_IntervalCompound* Type::mutable_interval_compound() ABSL_ATTRIBUTE_LIFETIME_BOUND {
