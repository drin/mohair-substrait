...
#ifndef GOOGLE_PROTOBUF_INCLUDED_skytether_2fmohair_2ftopology_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_skytether_2fmohair_2ftopology_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_skytether_2fmohair_2ftopology_2eproto
...
struct TableStruct_skytether_2fmohair_2ftopology_2eproto {
  static const ::uint32_t offsets[];
};
extern const ::google::protobuf::internal::DescriptorTable
    descriptor_table_skytether_2fmohair_2ftopology_2eproto;
namespace skytether {
namespace mohair {
...
/* @@protoc_insertion_point(class_definition:skytether.mohair.MemoryResources) */ {
 public:
  ...
  MemoryResources* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "skytether.mohair.MemoryResources"; }
 ...
 public:
  ...
  public:
  // optional .skytether.mohair.MemoryType memory_type = 2 [json_name = "memoryType"];
  bool has_memory_type() const;
  void clear_memory_type() ;
  ::skytether::mohair::MemoryType memory_type() const;
  void set_memory_type(::skytether::mohair::MemoryType value);

  private:
  ::skytether::mohair::MemoryType _internal_memory_type() const;
  void _internal_set_memory_type(::skytether::mohair::MemoryType value);
  ...
  public:
  // @@protoc_insertion_point(class_scope:skytether.mohair.MemoryResources)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_skytether_2fmohair_2ftopology_2eproto;
};
// -------------------------------------------------------------------

class ComputeResources final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:skytether.mohair.ComputeResources) */ {
 public:
  ...
  ComputeResources* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "skytether.mohair.ComputeResources"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:skytether.mohair.ComputeResources)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<
...
/* @@protoc_insertion_point(class_definition:skytether.mohair.ServiceConfig) */ {
 public:
  ...
  ServiceConfig* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "skytether.mohair.ServiceConfig"; }
 ...
 public:
  ...
  // repeated .skytether.mohair.ServiceConfig downstream_services = 4 [json_name = "downstreamServices"];
  ...
  ::skytether::mohair::ServiceConfig* mutable_downstream_services(int index);
  ::google::protobuf::RepeatedPtrField<::skytether::mohair::ServiceConfig>* mutable_downstream_services();

  private:
  const ::google::protobuf::RepeatedPtrField<::skytether::mohair::ServiceConfig>& _internal_downstream_services() const;
  ::google::protobuf::RepeatedPtrField<::skytether::mohair::ServiceConfig>* _internal_mutable_downstream_services();
  public:
  const ::skytether::mohair::ServiceConfig& downstream_services(int index) const;
  ::skytether::mohair::ServiceConfig* add_downstream_services();
  const ::google::protobuf::RepeatedPtrField<::skytether::mohair::ServiceConfig>& downstream_services() const;
  // repeated .skytether.mohair.ComputeResources service_compute = 6 [json_name = "serviceCompute"];
  ...
  ::skytether::mohair::ComputeResources* mutable_service_compute(int index);
  ::google::protobuf::RepeatedPtrField<::skytether::mohair::ComputeResources>* mutable_service_compute();

  private:
  const ::google::protobuf::RepeatedPtrField<::skytether::mohair::ComputeResources>& _internal_service_compute() const;
  ::google::protobuf::RepeatedPtrField<::skytether::mohair::ComputeResources>* _internal_mutable_service_compute();
  public:
  const ::skytether::mohair::ComputeResources& service_compute(int index) const;
  ::skytether::mohair::ComputeResources* add_service_compute();
  const ::google::protobuf::RepeatedPtrField<::skytether::mohair::ComputeResources>& service_compute() const;
  ...
  public:
  // optional .skytether.mohair.MemoryResources service_mem = 5 [json_name = "serviceMem"];
  bool has_service_mem() const;
  void clear_service_mem() ;
  const ::skytether::mohair::MemoryResources& service_mem() const;
  PROTOBUF_NODISCARD ::skytether::mohair::MemoryResources* release_service_mem();
  ::skytether::mohair::MemoryResources* mutable_service_mem();
  void set_allocated_service_mem(::skytether::mohair::MemoryResources* value);
  void unsafe_arena_set_allocated_service_mem(::skytether::mohair::MemoryResources* value);
  ::skytether::mohair::MemoryResources* unsafe_arena_release_service_mem();

  private:
  const ::skytether::mohair::MemoryResources& _internal_service_mem() const;
  ::skytether::mohair::MemoryResources* _internal_mutable_service_mem();
  ...
  public:
  // .skytether.mohair.DeviceClass platform_class = 3 [json_name = "platformClass"];
  void clear_platform_class() ;
  ::skytether::mohair::DeviceClass platform_class() const;
  void set_platform_class(::skytether::mohair::DeviceClass value);

  private:
  ::skytether::mohair::DeviceClass _internal_platform_class() const;
  void _internal_set_platform_class(::skytether::mohair::DeviceClass value);

  public:
  // @@protoc_insertion_point(class_scope:skytether.mohair.ServiceConfig)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<
  ...
  struct Impl_ {
    ...
    ::google::protobuf::internal::HasBits<1> _has_bits_;
    mutable ::google::protobuf::internal::CachedSize _cached_size_;
    ::google::protobuf::RepeatedPtrField< ::skytether::mohair::ServiceConfig > downstream_services_;
    ::google::protobuf::RepeatedPtrField< ::skytether::mohair::ComputeResources > service_compute_;
    ::google::protobuf::internal::ArenaStringPtr service_location_;
    ::skytether::mohair::MemoryResources* service_mem_;
    bool is_active_;
    int platform_class_;
    PROTOBUF_TSAN_DECLARE_MEMBER
  };
...
inline ::uint32_t ComputeResources::count_cores() const {
  // @@protoc_insertion_point(field_get:skytether.mohair.ComputeResources.count_cores)
  return _internal_count_cores();
}
inline void ComputeResources::set_count_cores(::uint32_t value) {
  _internal_set_count_cores(value);
  // @@protoc_insertion_point(field_set:skytether.mohair.ComputeResources.count_cores)
}
...
inline float ComputeResources::core_freqs(int index) const {
  // @@protoc_insertion_point(field_get:skytether.mohair.ComputeResources.core_freqs)
...
inline void ComputeResources::set_core_freqs(int index, float value) {
  ...
  // @@protoc_insertion_point(field_set:skytether.mohair.ComputeResources.core_freqs)
}
inline void ComputeResources::add_core_freqs(float value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _internal_mutable_core_freqs()->Add(value);
  // @@protoc_insertion_point(field_add:skytether.mohair.ComputeResources.core_freqs)
}
inline const ::google::protobuf::RepeatedField<float>& ComputeResources::core_freqs() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:skytether.mohair.ComputeResources.core_freqs)
  return _internal_core_freqs();
}
inline ::google::protobuf::RepeatedField<float>* ComputeResources::mutable_core_freqs()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:skytether.mohair.ComputeResources.core_freqs)
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::uint32_t MemoryResources::count_mebibytes() const {
  // @@protoc_insertion_point(field_get:skytether.mohair.MemoryResources.count_mebibytes)
...
inline void MemoryResources::set_count_mebibytes(::uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:skytether.mohair.MemoryResources.count_mebibytes)
}
...
inline ::skytether::mohair::MemoryType MemoryResources::memory_type() const {
  // @@protoc_insertion_point(field_get:skytether.mohair.MemoryResources.memory_type)
  return _internal_memory_type();
}
inline void MemoryResources::set_memory_type(::skytether::mohair::MemoryType value) {
  _internal_set_memory_type(value);
  _impl_._has_bits_[0] |= 0x00000001u;
  // @@protoc_insertion_point(field_set:skytether.mohair.MemoryResources.memory_type)
}
inline ::skytether::mohair::MemoryType MemoryResources::_internal_memory_type() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return static_cast<::skytether::mohair::MemoryType>(_impl_.memory_type_);
}
inline void MemoryResources::_internal_set_memory_type(::skytether::mohair::MemoryType value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::uint32_t MemoryResources::count_channels() const {
  // @@protoc_insertion_point(field_get:skytether.mohair.MemoryResources.count_channels)
...
inline void MemoryResources::set_count_channels(::uint32_t value) {
  ...
  _impl_._has_bits_[0] |= 0x00000002u;
  // @@protoc_insertion_point(field_set:skytether.mohair.MemoryResources.count_channels)
}
...
inline ::uint32_t MemoryResources::memory_freq() const {
  // @@protoc_insertion_point(field_get:skytether.mohair.MemoryResources.memory_freq)
  return _internal_memory_freq();
}
inline void MemoryResources::set_memory_freq(::uint32_t value) {
  _internal_set_memory_freq(value);
  _impl_._has_bits_[0] |= 0x00000004u;
  // @@protoc_insertion_point(field_set:skytether.mohair.MemoryResources.memory_freq)
}
...
inline bool ServiceConfig::is_active() const {
  // @@protoc_insertion_point(field_get:skytether.mohair.ServiceConfig.is_active)
  return _internal_is_active();
}
inline void ServiceConfig::set_is_active(bool value) {
  _internal_set_is_active(value);
  // @@protoc_insertion_point(field_set:skytether.mohair.ServiceConfig.is_active)
}
...
inline const std::string& ServiceConfig::service_location() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:skytether.mohair.ServiceConfig.service_location)
...
inline PROTOBUF_ALWAYS_INLINE void ServiceConfig::set_service_location(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:skytether.mohair.ServiceConfig.service_location)
}
inline std::string* ServiceConfig::mutable_service_location() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ...
  // @@protoc_insertion_point(field_mutable:skytether.mohair.ServiceConfig.service_location)
  return _s;
}
...
inline std::string* ServiceConfig::release_service_location() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:skytether.mohair.ServiceConfig.service_location)
...
inline void ServiceConfig::set_allocated_service_location(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:skytether.mohair.ServiceConfig.service_location)
}
...
inline ::skytether::mohair::DeviceClass ServiceConfig::platform_class() const {
  // @@protoc_insertion_point(field_get:skytether.mohair.ServiceConfig.platform_class)
  return _internal_platform_class();
}
inline void ServiceConfig::set_platform_class(::skytether::mohair::DeviceClass value) {
  _internal_set_platform_class(value);
  // @@protoc_insertion_point(field_set:skytether.mohair.ServiceConfig.platform_class)
}
inline ::skytether::mohair::DeviceClass ServiceConfig::_internal_platform_class() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return static_cast<::skytether::mohair::DeviceClass>(_impl_.platform_class_);
}
inline void ServiceConfig::_internal_set_platform_class(::skytether::mohair::DeviceClass value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::skytether::mohair::ServiceConfig* ServiceConfig::mutable_downstream_services(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:skytether.mohair.ServiceConfig.downstream_services)
  return _internal_mutable_downstream_services()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField<::skytether::mohair::ServiceConfig>* ServiceConfig::mutable_downstream_services()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:skytether.mohair.ServiceConfig.downstream_services)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_downstream_services();
}
inline const ::skytether::mohair::ServiceConfig& ServiceConfig::downstream_services(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:skytether.mohair.ServiceConfig.downstream_services)
  return _internal_downstream_services().Get(index);
}
inline ::skytether::mohair::ServiceConfig* ServiceConfig::add_downstream_services() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::skytether::mohair::ServiceConfig* _add = _internal_mutable_downstream_services()->Add();
  // @@protoc_insertion_point(field_add:skytether.mohair.ServiceConfig.downstream_services)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::skytether::mohair::ServiceConfig>& ServiceConfig::downstream_services() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:skytether.mohair.ServiceConfig.downstream_services)
  return _internal_downstream_services();
}
inline const ::google::protobuf::RepeatedPtrField<::skytether::mohair::ServiceConfig>&
ServiceConfig::_internal_downstream_services() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.downstream_services_;
}
inline ::google::protobuf::RepeatedPtrField<::skytether::mohair::ServiceConfig>*
...
inline const ::skytether::mohair::MemoryResources& ServiceConfig::_internal_service_mem() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  const ::skytether::mohair::MemoryResources* p = _impl_.service_mem_;
  return p != nullptr ? *p : reinterpret_cast<const ::skytether::mohair::MemoryResources&>(::skytether::mohair::_MemoryResources_default_instance_);
}
inline const ::skytether::mohair::MemoryResources& ServiceConfig::service_mem() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:skytether.mohair.ServiceConfig.service_mem)
  return _internal_service_mem();
}
inline void ServiceConfig::unsafe_arena_set_allocated_service_mem(::skytether::mohair::MemoryResources* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.service_mem_);
  }
  _impl_.service_mem_ = reinterpret_cast<::skytether::mohair::MemoryResources*>(value);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:skytether.mohair.ServiceConfig.service_mem)
}
inline ::skytether::mohair::MemoryResources* ServiceConfig::release_service_mem() {
  ::google::protobuf::internal::TSanWrite(&_impl_);

  _impl_._has_bits_[0] &= ~0x00000001u;
  ::skytether::mohair::MemoryResources* released = _impl_.service_mem_;
...
inline ::skytether::mohair::MemoryResources* ServiceConfig::unsafe_arena_release_service_mem() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:skytether.mohair.ServiceConfig.service_mem)

  _impl_._has_bits_[0] &= ~0x00000001u;
  ::skytether::mohair::MemoryResources* temp = _impl_.service_mem_;
  _impl_.service_mem_ = nullptr;
  return temp;
}
inline ::skytether::mohair::MemoryResources* ServiceConfig::_internal_mutable_service_mem() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (_impl_.service_mem_ == nullptr) {
    auto* p = ::google::protobuf::Message::DefaultConstruct<::skytether::mohair::MemoryResources>(GetArena());
    _impl_.service_mem_ = reinterpret_cast<::skytether::mohair::MemoryResources*>(p);
  }
  return _impl_.service_mem_;
}
inline ::skytether::mohair::MemoryResources* ServiceConfig::mutable_service_mem() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000001u;
  ::skytether::mohair::MemoryResources* _msg = _internal_mutable_service_mem();
  // @@protoc_insertion_point(field_mutable:skytether.mohair.ServiceConfig.service_mem)
  return _msg;
}
inline void ServiceConfig::set_allocated_service_mem(::skytether::mohair::MemoryResources* value) {
  ...
  _impl_.service_mem_ = reinterpret_cast<::skytether::mohair::MemoryResources*>(value);
  // @@protoc_insertion_point(field_set_allocated:skytether.mohair.ServiceConfig.service_mem)
}
...
inline ::skytether::mohair::ComputeResources* ServiceConfig::mutable_service_compute(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:skytether.mohair.ServiceConfig.service_compute)
  return _internal_mutable_service_compute()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField<::skytether::mohair::ComputeResources>* ServiceConfig::mutable_service_compute()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:skytether.mohair.ServiceConfig.service_compute)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_service_compute();
}
inline const ::skytether::mohair::ComputeResources& ServiceConfig::service_compute(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:skytether.mohair.ServiceConfig.service_compute)
  return _internal_service_compute().Get(index);
}
inline ::skytether::mohair::ComputeResources* ServiceConfig::add_service_compute() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::skytether::mohair::ComputeResources* _add = _internal_mutable_service_compute()->Add();
  // @@protoc_insertion_point(field_add:skytether.mohair.ServiceConfig.service_compute)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::skytether::mohair::ComputeResources>& ServiceConfig::service_compute() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:skytether.mohair.ServiceConfig.service_compute)
  return _internal_service_compute();
}
inline const ::google::protobuf::RepeatedPtrField<::skytether::mohair::ComputeResources>&
ServiceConfig::_internal_service_compute() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.service_compute_;
}
inline ::google::protobuf::RepeatedPtrField<::skytether::mohair::ComputeResources>*
...
template <>
struct is_proto_enum<::skytether::mohair::DeviceClass> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::skytether::mohair::DeviceClass>() {
  return ::skytether::mohair::DeviceClass_descriptor();
}
template <>
struct is_proto_enum<::skytether::mohair::MemoryType> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::skytether::mohair::MemoryType>() {
  return ::skytether::mohair::MemoryType_descriptor();
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_skytether_2fmohair_2ftopology_2eproto_2epb_2eh
