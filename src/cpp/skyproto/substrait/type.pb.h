...
#ifndef skyproto_2fsubstrait_2ftype_2eproto_2epb_2eh
#define skyproto_2fsubstrait_2ftype_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:skyproto.substrait.Type.IntervalCompound) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(Type_IntervalCompound* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(Type_IntervalCompound));
  }
#endif
  ...
  Type_IntervalCompound* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // skyproto_2fsubstrait_2ftype_2eproto_2epb_2eh
